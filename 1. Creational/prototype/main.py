...
class SomeComponent:
    ...
    def __copy__(self):
        ...
        some_circular_ref = copy.copy(
            self.some_circular_ref)
...
if __name__ == "__main__":
    ...
    shallow_copied_component = copy.copy(
        component)
    ...
    # Let's change the list in deep_copied_component and see if it changes in component.
    ...
    if 10 in deep_copied_component.some_list_of_objects[1]:
        print(
            "Changing objects in the "
            "`component`'s some_list_of_objects "
